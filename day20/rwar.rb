...
puts("The product of corner tile IDs is:", corner_ids.inject(:*))
...
MAP = arrangement.flat_map do |tiles|
...
puts("The water roughness of the sea monster habitat is:", roughness)